...
class RedisHandler:
    ...
    def __init__(self):
        self.host = '121.43.168.7'
        self.port = 6380
        self.database = 2
        self.password = 'uV2pVUxZaO'
        self.charset = 'UTF-8'
...
# RedisHandler().set_string("testchannelAgent::testconfig::testwechat",'1234569')
# RedisHandler().del_cache("testchannelAgent::testconfig::testwechat")