...
from utils.others_tool.models import DependentType
from utils.others_tool.models import TestCase, DependentCaseData, DependentData
...
class DependentCase:
    ...
    def is_dependent(self) -> Union[Dict, bool]:
        ...
        print("============",type(_dependence_case_dates),"===============")
    ...
    def get_dependent_data(self) -> None:
        ...
        :return:
        """
        print("get_dependent_data called")
